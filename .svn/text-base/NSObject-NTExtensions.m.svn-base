...
- (NSString*)formattedDescription:(int)prependTabs prependReturn:(BOOL)prependReturn;
@end
...
- (NSString*)formattedDescription:(int)prependTabs;
{
	...
	if ([self isKindOfClass:[NSArray class]])
	{
		...
		while (obj = [enumerator nextObject])
		{
			...
			{		
				...
				[tmp appendString:[NSString stringWithFormat:@"%d: %@", index++, obj]];
			}
		}
