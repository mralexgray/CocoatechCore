...
- (void)dealloc;
{
	if (self.prefsRef)
	{
		SCPreferencesUnscheduleFromRunLoop(self.prefsRef, CFRunLoopGetCurrent(), kCFRunLoopDefaultMode);
...
- (void)setupAllPrefsNotification;
{
	...
	SCPreferencesScheduleWithRunLoop(self.prefsRef, CFRunLoopGetCurrent(),kCFRunLoopDefaultMode);
}
