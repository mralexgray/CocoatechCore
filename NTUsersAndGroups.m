...
- (NSMenu*)groupMenu;
{
	...
	[self groupMenu:menu target:nil action:0];
	
	return menu;
}

- (void)groupMenu:(NSMenu*)menu target:(id)target action:(SEL)action;
{    
...
- (NSMenu*)userMenu;
{
	...
	[self userMenu:menu target:nil action:0];
	
	return menu;
}

- (void)userMenu:(NSMenu*)menu target:(id)target action:(SEL)action;
{
